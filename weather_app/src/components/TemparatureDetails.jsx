...
function TemparatureDetails({ weather }) {
  const {
    details,
    icon,
    temp,
  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between text-white py-3">
        <img
          src={
            iconUrlFromCode(icon) ||
            "https://e0.pxfuel.com/wallpapers/365/902/desktop-wallpaper-dark-mist-trees-forest-tablet-laptop-background-16864-dark-forest-laptop.jpg"
          }
          className="w-20"
          alt=""
        />
      ...
      <div className="flex flex-col sm:flex-row justify-center space-x-2 text-white text-sm py-3">
        <UilSun />
